"""
Django settings for MovieAndSeriesProject project.
...
SECRET_KEY = 'django-insecure-!h+qt%##_g6y9s#a!+sxfx-2z5w0b)xr*74#u@-ab$q$%pvq_)'
...
ROOT_URLCONF = 'MovieAndSeriesProject.urls'
...
WSGI_APPLICATION = 'MovieAndSeriesProject.wsgi.application'
